CREATE DATABASE BT2_QuanLyGiaoVu
USE BT2_QuanLyGiaoVu

CREATE TABLE HOCVIEN
(
	MAHV CHAR(5) CONSTRAINT HOCVIEN_MAHV_PK PRIMARY KEY,
	HO VARCHAR(40),
	TEN VARCHAR(10),
...
CREATE TABLE LOP
(
	MALOP CHAR(5) CONSTRAINT LOP_MALOP_PK PRIMARY KEY,
	TENLOP VARCHAR(40),
	TRGLOP CHAR(5), 
	SISO TINYINT,
	MAGVCN CHAR(4), 
...
CREATE TABLE MONHOC
(
	MAMH VARCHAR(10) CONSTRAINT MONHOC_MAMH_PK PRIMARY KEY,
	TENMH VARCHAR(40),
	TCLT TINYINT,
	TCTH TINYINT,
	MAKHOA VARCHAR(4)
...
(
	...
	CONSTRAINT DIEUKIEN_PK PRIMARY KEY(MAMH, MAMH_TRUOC)
)

CREATE TABLE GIAOVIEN
(
	MAGV CHAR(4) CONSTRAINT GIAOVIEN_MAGV_PK PRIMARY KEY,
	HOTEN VARCHAR(40),
	HOCVI VARCHAR (10),
	HOCHAM VARCHAR(10),
	GIOITINH VARCHAR(3),
...
ALTER TABLE KHOA ADD CONSTRAINT KHOA_TRGKHOA_FK FOREIGN KEY (TRGKHOA)
			REFERENCES GIAOVIEN(MAGV)

ALTER TABLE MONHOC ADD CONSTRAINT MONHOC_MAKHOA_FK FOREIGN KEY (MAKHOA)
			REFERENCES KHOA(MAKHOA)

ALTER TABLE DIEUKIEN ADD CONSTRAINT DIEUKIEN_MAMH_FK FOREIGN KEY (MAMH)
			REFERENCES MONHOC(MAMH)

ALTER TABLE DIEUKIEN ADD CONSTRAINT DIEUKIEN_MAMHTRUOC_FK FOREIGN KEY (MAMH)
			REFERENCES MONHOC(MAMH)

ALTER TABLE GIAOVIEN ADD CONSTRAINT GIAOVIEN_MAKHOA_FK FOREIGN KEY (MAKHOA)
			REFERENCES KHOA(MAKHOA)

ALTER TABLE LOP ADD CONSTRAINT LOP_TRGLOP_FK FOREIGN KEY (TRGLOP)
			REFERENCES HOCVIEN(MAHV)

ALTER TABLE LOP ADD CONSTRAINT LOP_MAGVCN_FK FOREIGN KEY (MAGVCN)
			REFERENCES GIAOVIEN(MAGV)

ALTER TABLE HOCVIEN ADD CONSTRAINT HOCVIEN_MALOP_FK FOREIGN KEY(MALOP)
			REFERENCES LOP(MALOP)

ALTER TABLE GIANGDAY ADD CONSTRAINT GIANGDAY_MALOP_FK FOREIGN KEY (MALOP)
			REFERENCES LOP(MALOP)

ALTER TABLE GIANGDAY ADD CONSTRAINT GIANGDAY_MAMH_FK FOREIGN KEY (MAMH)
			REFERENCES MONHOC(MAMH)
ALTER TABLE GIANGDAY ADD CONSTRAINT GIANGDAY_MAGV_FK FOREIGN KEY (MAGV)
			REFERENCES GIAOVIEN(MAGV)

ALTER TABLE KETQUATHI ADD CONSTRAINT KQT_MAHV_FK FOREIGN KEY(MAHV)
			REFERENCES HOCVIEN(MAHV)

ALTER TABLE KETQUATHI ADD CONSTRAINT KQT_MAMH_FK FOREIGN KEY(MAMH)
			REFERENCES MONHOC(MAMH)
...
INSERT INTO GIANGDAY VALUES ('K12','CTDLGT','GV15','3','2006','01/08/2007','15/12/2007') --Data has been changed to conform to I.12
